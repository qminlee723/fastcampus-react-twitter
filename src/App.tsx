...
function App() {
  return (
    <Routes>
      ...
      <Route path="/profile" element={<h1>Pofile Page</h1>} />
      <Route path="/profile/edit" element={<h1>Pofile Edit Page</h1>} />
      <Route path="/notificationst" element={<h1>Notifications Page</h1>} />
